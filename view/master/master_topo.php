...
<body id="page1">
	<header>
		<div class="container">
			<nav id="mainNav">
				<ul>
					<li><a href="<?php echo BASE_URL . 'controller/redirecionamento/redir.php?menu=1';?>">BEBER</a></li>
					<li><a href="<?php echo BASE_URL . 'controller/redirecionamento/redir.php?menu=2';?>">RANKING</a></li>
				</ul>
			</nav>
		</div>
	</header>
